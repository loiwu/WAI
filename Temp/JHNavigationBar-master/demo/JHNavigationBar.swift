    ...
    var overlay: UIView? {
        ...
        set {
            if let newValue = newValue {
                objc_setAssociatedObject(self, &AssociatedKeys.overLay, newValue as UIView?, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
            }
        }
    }
